...
if (isset($_POST['form1'])) {
    ...
    if(!empty($_POST['cust_name']) && !preg_match("/^([a-zA-Z' ]+)$/", $_POST['cust_name'])){
        $valid = 0;
    ...
    if (!empty($_POST['cust_phone']) && !preg_match ("/^[0-9]{10}+$/", $_POST['cust_phone']) ){
        $valid = 0;
    ...
    if(!empty($_POST['cust_city']) && !preg_match ("/^[a-zA-z]*$/", $_POST['cust_city'])) {
        $valid = 0;
        $error_message .= "Please Enter Valid City<br>";
    }
    ...
    if(!empty($_POST['cust_state']) && !preg_match ("/^[a-zA-z]*$/", $_POST['cust_state'])) {
        $valid = 0;
        $error_message .= "Please Enter Valid State<br>";
    }
